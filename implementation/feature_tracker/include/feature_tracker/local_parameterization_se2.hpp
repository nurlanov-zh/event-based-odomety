#ifndef SOPHUS_LOCAL_PARAMETERIZATION_SE2_HPP
#define SOPHUS_LOCAL_PARAMETERIZATION_SE2_HPP
...
class LocalParameterizationSE2 : public ceres::LocalParameterization
{
   public:
	...
	// Jacobian of SE2 plus operation for Ceres
	//
	// Dx T * exp(x)  with  x=0
	//
								 ...
								 double* jacobian_raw) const
	{
		...
		Eigen::Map<Eigen::Matrix<double, SE2d::num_parameters, SE2d::DoF,
								 Eigen::RowMajor>>
